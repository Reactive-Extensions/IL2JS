...
namespace System.Compiler{
  ...
  class StandardVisitor: Visitor{
...
#endif
        case NodeType.GenericClassInstance:
          return this.VisitGenericClassInstance((GenericClassInstance)node);
        case NodeType.GenericDelegateNodeInstance:
          return this.VisitGenericDelegateNodeInstance((GenericDelegateNodeInstance)node);
        case NodeType.GenericEnumNodeInstance:
          return this.VisitGenericEnumNodeInstance((GenericEnumNodeInstance)node);
        case NodeType.GenericInterfaceExpressionInstance:
          return this.VisitGenericInterfaceExpressionInstance((GenericInterfaceExpressionInstance)node);
        case NodeType.GenericInterfaceInstance:
          return this.VisitGenericInterfaceInstance((GenericInterfaceInstance)node);
        case NodeType.GenericStructInstance:
          return this.VisitGenericStructInstance((GenericStructInstance)node);
        case NodeType.GenericMethodInstance:
          return this.VisitGenericMethodInstance((GenericMethodInstance)node);
    ...
    public virtual GenericClassInstance VisitGenericClassInstance(GenericClassInstance node)
    {
        return (GenericClassInstance)VisitGenericTypeInstance(node);
    }

    public virtual GenericDelegateNodeInstance VisitGenericDelegateNodeInstance(GenericDelegateNodeInstance node)
    {
        return (GenericDelegateNodeInstance)VisitGenericTypeInstance(node);
    }

    public virtual GenericEnumNodeInstance VisitGenericEnumNodeInstance(GenericEnumNodeInstance node)
    {
        return (GenericEnumNodeInstance)VisitGenericTypeInstance(node);
    }

    public virtual GenericInterfaceExpressionInstance VisitGenericInterfaceExpressionInstance(GenericInterfaceExpressionInstance node)
    {
        return (GenericInterfaceExpressionInstance)VisitGenericTypeInstance(node);
    }

    public virtual GenericInterfaceInstance VisitGenericInterfaceInstance(GenericInterfaceInstance node)
    {
        return (GenericInterfaceInstance)VisitGenericTypeInstance(node);
    }

    public virtual GenericStructInstance VisitGenericStructInstance(GenericStructInstance node)
    {
        return (GenericStructInstance)VisitGenericTypeInstance(node);
    }
