...
namespace System.Compiler{
  ...
  public enum NodeType {
    ...
    GenericDelegateNodeInstance,
    GenericEnumNodeInstance,
    GenericInterfaceInstance,
    GenericInterfaceExpressionInstance,
    GenericStructInstance,
    GenericMethodInstance,
    GenericFieldInstance,
    GenericPropertyInstance,
    GenericEventInstance,
  }
  [Flags]
  ...
  public sealed class TrivialHashtable{
    ...
    public IEnumerable<HashEntry> GetEnumerator()
    {
  ...
  public abstract class Node : IUniqueKey{
    ...
    private object nodeMetaData;
    /// <summary>
    /// On object associated with this CCINode for applications to track metadata about the CCI nodes.
    /// </summary>
    public object NodeMetaData
    {
        get { return this.nodeMetaData; }
        set { this.nodeMetaData = value; }
    }
  ...
  public class Module : Node, IDisposable{
    ...
    private System.Guid persistentmvid;
    public System.Guid PersistentMvid
    {
        get
        {
            return this.persistentmvid;
        }
        set
        {
            this.persistentmvid = value;
        }
    }
  ...
  public class AssemblyNode : Module{ //An assembly is a module with a strong name
    ...
    public byte[] KeyBlob;
    public static bool GetReflectionDebugInfo;
#endif
#if !NoReflection
    ...
    public static AssemblyNode GetAssembly(System.Reflection.Assembly runtimeAssembly){
      return AssemblyNode.GetAssembly(runtimeAssembly, null, GetReflectionDebugInfo, true, false);
    }
    public static AssemblyNode GetAssembly(System.Reflection.Assembly runtimeAssembly, IDictionary cache){
        return AssemblyNode.GetAssembly(runtimeAssembly, cache, GetReflectionDebugInfo, false, false);
    }
    ...
    internal void InitializePostAssemblyLoadAndFire (Module referringModule) {
      AssemblyNode referringAssembly = referringModule as AssemblyNode;
      if (referringAssembly != null && referringAssembly.AfterAssemblyLoad != null) {
        this.AfterAssemblyLoad = referringAssembly.AfterAssemblyLoad; // pass it along so any assembly references from "this" also get it
        AfterAssemblyLoadProcessing();
      }
    }
  ...
  protected internal virtual void ApplyOutOfBandContracts(){
    ...
    public void SetTypeCode(ElementType typeCode)
    {
   ...
   internal TrivialHashtableUsingWeakReferences structurallyEquivalentMethod;
    ...
    private static void WriteModuleName(StringBuilder uniqueMangledNameBuilder, Module module)
    {
        var assembly = module as AssemblyNode;
        if (assembly != null)
        {
            uniqueMangledNameBuilder.Append("{");
            uniqueMangledNameBuilder.Append(assembly.StrongName);
            uniqueMangledNameBuilder.Append("}");
        }
        else
        {
            uniqueMangledNameBuilder.Append("[");
            uniqueMangledNameBuilder.Append(module.Name);
            uniqueMangledNameBuilder.Append("[");
        }
    }
    ...
    public virtual Identifier/*!*/ GetMangledTemplateInstanceName(TypeNodeList/*!*/ templateArguments, out Identifier/*!*/ uniqueMangledName, out bool notFullySpecialized){
        ...
        StringBuilder uniqueMangledNameBuilder = new StringBuilder();
        GetMangledTemplateInstanceName(templateArguments, out notFullySpecialized, mangledNameBuilder, uniqueMangledNameBuilder);
        uniqueMangledName = Identifier.For(uniqueMangledNameBuilder.ToString());      
       return Identifier.For(mangledNameBuilder.ToString());
    }

    private void GetMangledTemplateInstanceName(TypeNodeList/*!*/ templateArguments, out bool notFullySpecialized, StringBuilder mangledNameBuilder, StringBuilder uniqueMangledNameBuilder)
    {  
      mangledNameBuilder.Append(this.Name.ToString());
      WriteModuleName(uniqueMangledNameBuilder, this.DeclaringModule);
      uniqueMangledNameBuilder.Append(this.Name.ToString());
      uniqueMangledNameBuilder.Append('|');
      ...
      for (int i = 0, n = templateArguments.Count; i < n; i++){
        ...
        {
            bool dummy;
            t.GetMangledTemplateInstanceName(t.TemplateArguments, out dummy, mangledNameBuilder, uniqueMangledNameBuilder);
        }
        else
        {
            mangledNameBuilder.Append(t.FullName);
            WriteModuleName(uniqueMangledNameBuilder, t.declaringModule);
    ...
    public virtual TypeNode/*!*/ GetTemplateInstance(Module module, TypeNode referringType, TypeNode declaringType, TypeNodeList templateArguments) {
      ...
      public override void ClearCachedValues()
      {
        ...
        this.structurallyEquivalentMethod = new TrivialHashtableUsingWeakReferences();
  ...
  protected internal Pointer pointerType;
    ...
    public Method GetMethodByDefinitionId(int definitionId)
    {
        ...
        for (int i = 0, n = members.Count; i < n; i++)
        {
            ...
            if (meth == null) continue;
            if (meth.DefinitionId == definitionId) return meth;
        }
        return null;
    }
    ...
    public virtual bool IsStructurallyEquivalentTo(TypeNode type){
      ...
      if (this is IGenericTypeInstance && this.NodeType == type.NodeType)
      {
          var leftGenericTypeInstance = this as IGenericTypeInstance;
          var rightGenericTypeInstance = type as IGenericTypeInstance;
          if (leftGenericTypeInstance.Generic.IsStructurallyEquivalentTo(rightGenericTypeInstance.Generic) &&
              IsStructurallyEquivalentList(leftGenericTypeInstance.GenericArguments, rightGenericTypeInstance.GenericArguments))
          {
              return true;
          }
      }
    ...
    public static TypeFlags GetVisibilityUnion(TypeFlags vis1, TypeFlags vis2)
    {
        vis1 &= TypeFlags.VisibilityMask;
        vis2 &= TypeFlags.VisibilityMask;
        switch (vis1)
        {
            case TypeFlags.Public:
                return TypeFlags.Public;
            case TypeFlags.NestedAssembly:
                switch (vis2)
                {
                    case TypeFlags.Public:
    ...
    public interface IGenericTypeInstance : IGenericInstance<TypeNode>
    {
    }

    public interface IGenericMemberInstance : IGenericInstance<Member>
    {
    }

    public interface IGenericInstance<T>
    {
        TypeNodeList GenericArguments
        {
            get;
            set;
        }
        ...
        IGenericInstance<T> Create(T generic, TypeNodeList genericArguments);
    }

    public static class GenericTypeInstanceHelpers
    {
        public static bool IsStructurallyEquivalentTo(IGenericTypeInstance leftGenericInstance, TypeNode right)
        {
            var rightGenericInstance = right as IGenericTypeInstance;
            if (rightGenericInstance != null)
            {
                return IsStructurallyEquivalentTo(leftGenericInstance, rightGenericInstance.Generic, rightGenericInstance.GenericArguments);
            }
            else
            {
                return IsStructurallyEquivalentTo(leftGenericInstance, right.Template, right.ConsolidatedTemplateArguments);
            }
        }

        public static bool IsStructurallyEquivalentTo(IGenericTypeInstance leftGenericInstance, TypeNode rightTemplate, TypeNodeList rightTemplateArguments)
        {
            if (rightTemplate == null || rightTemplateArguments == null)
            {
                return false;
            }

            if (!leftGenericInstance.Generic.IsStructurallyEquivalentTo(rightTemplate))
            {
                return false;
            }
            var leftTemplateArguments = leftGenericInstance.GenericArguments;
            int nrOfArguments = leftTemplateArguments.Count;
            if (nrOfArguments != rightTemplateArguments.Count)
            {
                return false;
            }
            for (int i = 0; i < nrOfArguments; i++)
            {
                TypeNode leftArgument = leftTemplateArguments[i];
                TypeNode rightArgument = rightTemplateArguments[i];
                if (null == (object)leftArgument || null == (object)rightArgument)
                {
                    return false;
                }
                ...
                if (!leftArgument.IsStructurallyEquivalentTo(rightArgument))
                {
                    return false;
                }
            }
    ...
    {
        public GenericClassInstance(Class genericType, TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericClassInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }

        public TypeNodeList GenericArguments
        {
            get;
            set;
        }

        public TypeNode Generic
        {
            get;
            set;
        }

        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericClassInstance((Class)generic, genericArguments);
        }

        public override bool IsStructurallyEquivalentTo(TypeNode type)
        {
            return GenericTypeInstanceHelpers.IsStructurallyEquivalentTo(this, type);
        }
    }
    public class GenericDelegateNodeInstance : DelegateNode, IGenericTypeInstance
    {
        public GenericDelegateNodeInstance(DelegateNode genericType, TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericDelegateNodeInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }
        ...
        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericDelegateNodeInstance((DelegateNode)generic, genericArguments);
        }
    ...
    public class GenericEnumNodeInstance : EnumNode, IGenericTypeInstance
    {
        public GenericEnumNodeInstance(EnumNode genericType, TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericEnumNodeInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }
        ...
        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericEnumNodeInstance((EnumNode)generic, genericArguments);
        }
    ...
    public class GenericInterfaceExpressionInstance : InterfaceExpression, IGenericTypeInstance
    {
        public GenericInterfaceExpressionInstance(Interface genericType, TypeNodeList genericArguments) : base(null)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericInterfaceExpressionInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }
        ...
        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericInterfaceExpressionInstance((Interface)generic, genericArguments);
        }
    ...
    {
        public GenericInterfaceInstance(Interface genericType, TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericInterfaceInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }
        ...
        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericInterfaceInstance((Interface)generic, genericArguments);
        }
    ...
    public class GenericStructInstance : Struct, IGenericTypeInstance
    {
        public GenericStructInstance(Struct genericType, TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericStructInstance;
            Name = genericType.Name;
            Namespace = genericType.Namespace;
        }
        ...
        public IGenericInstance<TypeNode> Create(TypeNode generic, TypeNodeList genericArguments)
        {
            return new GenericStructInstance((Struct)generic, genericArguments);
        }
    ...
    public class GenericMethodInstance : Method, IGenericMemberInstance
    {
        public GenericMethodInstance(Method genericType, TypeNodeList genericArguments)
        {
            Debug.Assert(genericType.Template == null);
            Debug.Assert(genericType.DeclaringType.Template == null);
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericMethodInstance;
            Name = genericType.Name;
        }
        public GenericMethodInstance(Method genericType, TypeNodeList genericArguments, TypeNodeList genericMethodParameters)
        {
            Debug.Assert(genericType.Template == null);
            Generic = genericType;
            GenericArguments = genericArguments;
        ...
        public TypeNodeList GenericMethodParameters
        {
            get;
            set;
        }

        public Member Generic
        {
            get;
            set;
        }
        public IGenericInstance<Member> Create(Member generic, TypeNodeList genericArguments)
        {
            return new GenericMethodInstance((Method)generic, genericArguments);
        }

        public IGenericInstance<Member> Create(Member generic, TypeNodeList genericArguments, TypeNodeList genericMethodParameters)
        {
            return new GenericMethodInstance((Method)generic, genericArguments, genericMethodParameters);
        }

    }
    public class GenericFieldInstance : Field, IGenericMemberInstance
    {
        public GenericFieldInstance(Field genericType,TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericFieldInstance;
            Name = genericType.Name;
        }
        ...
        public IGenericInstance<Member> Create(Member generic, TypeNodeList genericArguments)
        {
            return new GenericFieldInstance((Field)generic, genericArguments);
        }

    }
    public class GenericPropertyInstance : Property, IGenericMemberInstance
    {
        public GenericPropertyInstance(Property genericType,TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericPropertyInstance;
            Name = genericType.Name;
        }
        ...
        public IGenericInstance<Member> Create(Member generic, TypeNodeList genericArguments)
        {
            return new GenericPropertyInstance((Property)generic, genericArguments);
        }

    }
    public class GenericEventInstance : Event, IGenericMemberInstance
    {
        public GenericEventInstance(Event genericType,TypeNodeList genericArguments)
        {
            Generic = genericType;
            GenericArguments = genericArguments;
            NodeType = NodeType.GenericEventInstance;
            Name = genericType.Name;
        ...
        public IGenericInstance<Member> Create(Member generic, TypeNodeList genericArguments)
        {
            return new GenericEventInstance((Event)generic, genericArguments);
        }
  ...
  public class ClassParameter : Class, ITypeParameter{
    ...
    public virtual MemberList GetAllMembersNamed(Identifier/*!*/ name) {
      lock (this) {
        ...
        TypeNode t = this;
        while (t != null) {
          MemberList members2 = t.GetMembersNamed(name);
          if (members2 != null)
            for (int i = 0, n = members2.Count; i < n; i++)
              result.Add(members2[i]);
          t = t.BaseType;
        }
        InterfaceList interfaces = this.Interfaces;
        if (interfaces != null)
  ...
  public class Method : Member{
...
#endif
    public delegate void MethodBodyProvider(Method/*!*/ method, object/*!*/ handle, bool asInstructionList, bool determineExternOnly);
    ...
    public Member DeclaringMember{
      get{
        if (this.declaringMember == null && this.DeclaringType != null) {
    ...
    public virtual Block Body{
      get{
        ...
        if (this.ProvideBody != null && this.ProviderHandle != null){
          lock (Module.GlobalLock){
            if (this.body == null){
              this.ProvideBody(this, this.ProviderHandle, false, false);
#if FxCop
        ...
        if (this.ProvideBody != null && this.ProviderHandle != null){
          lock (Module.GlobalLock){
            if (this.instructions == null){
              this.ProvideBody(this, this.ProviderHandle, true, false);
#if FxCop
    ...
    public virtual string GetUnmangledNameWithoutTypeParameters(bool omitParameterTypes){
      ...
      if (this.NodeType == NodeType.InstanceInitializer)
        ...
        if (lastDot < 0 || lastMangle < lastDot)
          lastMangle = -1;
        if (lastMangle > 0)
    ...
    private bool isExternCalculated;
    public virtual bool IsExtern{
        get
        {
            if (this.isExternCalculated)
            {
            ...
            if (this.ProvideBody != null && this.ProviderHandle != null)
            {
                lock (Module.GlobalLock)
                {
                    if (!this.isExternCalculated)
                    {
                        this.ProvideBody(this, this.ProviderHandle, false, true);
                    }
                }
            }
            return this.isExtern;
