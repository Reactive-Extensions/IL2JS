...
namespace System.Compiler{
  ...
  internal sealed class Ir2md{
    ...
    private bool methodEntriesAlreadyWritten;
    ...
    int GetAssemblyRefIndex(AssemblyNode/*!*/ assembly) {
        if (assembly.Location == "unknown:location")
            throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture,
              ExceptionStrings.UnresolvedAssemblyReferenceNotAllowed, assembly.StrongName));
    ...
    int GetMethodIndex(Method/*!*/ m) {
      ...
      if (index == null){
        ...
        Debug.Assert(!methodEntriesAlreadyWritten, "Table has already been written. Adding entries now will not make them be written out.");
    ...
    void PopulateConstantTable(){
      ...
      for (int i = 0; i < n; i++){
        ...
        if (p != null){
          ...
          if (t is Reference || ((t != p.Type || t == SystemTypes.Object)&& Literal.IsNullLiteral(p.DefaultValue)))
    ...
    void PopulateCustomAttributeTable(){
      ...
      for (int i = 0, n = this.nodesWithCustomAttributes.Count; i < n; i++){
        ...
        for (int j = 0, m = attrs.Count; j < m; j++){
          ...
          if (a.OriginalBlob != null)
          {
              table[k].Value = this.GetBlobIndex(a.OriginalBlob);
          }
          else
          {
    ...
    void PopulateMethodTable(){
      ...
      this.methodEntriesAlreadyWritten = true;
    ...
    void PopulateModuleTable(){
      ...
      mr[0].Mvid = this.GetGuidIndex(this.module.PersistentMvid != Guid.Empty ? this.module.PersistentMvid : Guid.NewGuid());
    }
    ...
    void VisitStruct(Struct/*!*/ Struct) {
      ...
      this.VisitReferencedType(Struct.BaseType);
    ...
    void WriteMethodSignature(BinaryWriter/*!*/ target, Method/*!*/ method) {
      if (this.UseGenerics){
        if (method.Template != null && method.Template.IsGeneric){
          ...
          Debug.Assert(unspecializedMethod != method);
