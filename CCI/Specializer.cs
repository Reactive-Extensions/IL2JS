...
namespace System.Compiler{
  ...
  class Specializer : StandardVisitor{
    ...
    private void ProvideTypeMembers(TypeNode/*!*/ typeNode, object/*!*/ handle)
    {
        ...
        // Avoid obvious recursion which sometimes overflows the stack as these can be nested over 200 levels.
        if (sHandler.Handle is SpecializerHandle)
        {
            var currentHandler = sHandler.Handle as SpecializerHandle;
            while (currentHandler != null)
            {
                sHandler = currentHandler;
                currentHandler = currentHandler.Handle as SpecializerHandle;
            }
        }
