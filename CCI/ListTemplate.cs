...
namespace System.Compiler{
  ...
  public class CciList<T, ListType> : System.Collections.Generic.List<T> where ListType : System.Collections.Generic.List<T>, new()
  {
      public CciList() : base(32) { }
      public CciList(int capacity) : base(capacity) { }
      public CciList(params T[] elements) : base(elements) { }
  ...
  public sealed class AssemblyReferenceList{
    ...
    {
        AssemblyReference[] ar = new AssemblyReference[this.count];
        Array.Copy(this.elements, ar, this.count);
        return ar;
    }
    public int Count{
      get{return this.count;}
  ...
  public sealed class AttributeList : CciList<AttributeNode, AttributeList>
  {
      public AttributeList() : base(8) { }
      public AttributeList(int capacity) : base(capacity) { }
      public AttributeList(params AttributeNode[] elements) : base(elements) { }
  }
...
#endif
  public sealed class LocalList : CciList<Local, LocalList>
  {
      public LocalList() : base(32) { }
      public LocalList(int capacity) : base(capacity) { }
      public LocalList(params Local[] elements) : base(elements) { }
  }
  ...
  public sealed class MethodList{
    ...
    public bool Contains(Method element)
    {
        int n = this.count;
        for (int i = 0; i < n; i++)
            if (elements[i] == element)
    ...
    public void Remove(Method member)
    {
        int n = this.count;
        for (int i = 0; i < n; i++)
        {
...
#endif
  public sealed class ResourceList : CciList<Resource, ResourceList>
  {
      public ResourceList() : base(32) { }
      public ResourceList(int capacity) : base(capacity) { }
      public ResourceList(params Resource[] elements) : base(elements) { }
  }
#if !MinimalReader
...
#endif
  public sealed class TypeNodeList : CciList<TypeNode, TypeNodeList> 
  {
    public TypeNodeList() : base(32) {}
    public TypeNodeList(int capacity) : base(capacity) {}
    public TypeNodeList(params TypeNode[] elements) : base(elements) { }
  }
#if !MinimalReader
