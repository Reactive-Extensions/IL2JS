...
namespace System.Linq.Parallel
{
    ...
    internal class SortHelper<TInputOutput, TKey> : SortHelper<TInputOutput>, IDisposable
    {
        ...
        {
            // @TODO: @BUG#414: avoid allocating a whole new values list if the underlying
            //     data source is already indexible.
        ...
        //
        // @TODO: we could constrain DOPs to be powers of two to avoid getting into this mess.
        //     Treating P = 5 as P = 8 adds another phase to the reduction, which implies more
        //     merging and more memory overhead.  We need to experiment to see what is best.
        //
