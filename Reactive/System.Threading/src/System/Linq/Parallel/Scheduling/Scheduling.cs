...
namespace System.Linq.Parallel
{
    ...
    internal static class Scheduling
    {
        ...
        // The size to use for bounded buffers. @TODO: @PERF: @BUG#509: arbitrary value, need to fine-tune.
        ...
        // @TODO: @PERF#523: for now, this is listed as infinite.  When we finish zombie support we need to change it.
