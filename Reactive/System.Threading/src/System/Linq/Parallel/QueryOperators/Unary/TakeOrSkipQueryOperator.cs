...
namespace System.Linq.Parallel
{
    ...
    internal sealed class TakeOrSkipQueryOperator<TResult> : UnaryQueryOperator<TResult, TResult>
    {
        ...
        class TakeOrSkipQueryOperatorEnumerator : QueryOperatorEnumerator<TResult, int>
        {
            ...
            private readonly FixedMaxHeap<int> m_sharedIndices; // The indices shared among partitions.
