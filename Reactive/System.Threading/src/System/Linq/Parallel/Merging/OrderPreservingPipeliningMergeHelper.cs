...
namespace System.Linq.Parallel
{
    ...
    internal class OrderPreservingPipeliningMergeHelper<TOutput> : IMergeHelper<TOutput>
    {
        ...
        private readonly PartitionedStream<TOutput, int> m_partitions; // Source partitions.
        ...
        {
            OrderPreservingPipeliningSpoolingTask<TOutput>.Spool(
...

        {
                ...
                :base(mergeHelper.m_taskGroupState)
            {
                ...
                m_producerHeap = new FixedMaxHeap<Producer>(partitionCount, s_producerComparer);
            ...
            {
                Queue<Pair<int, TOutput>> buffer = m_mergeHelper.m_buffers[producer];
                ...
                lock (bufferLock)
                {
                    ...
                    else
                    {
                        ...
                        m_mergeHelper.m_buffers[producer] = new Queue<Pair<int, TOutput>>(INITIAL_BUFFER_SIZE);
