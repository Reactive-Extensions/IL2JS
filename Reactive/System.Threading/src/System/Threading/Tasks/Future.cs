...
namespace System.Threading.Tasks
{
    ...
    public class Task<TResult> : Task
    {
        ...
        {
            get { return m_resultWasSet ? "" + m_result : Environment2.GetResourceString("TaskT_DebuggerNoResult"); }
        }
        ...
        internal Task ContinueWith(Action<Task<TResult>> continuationAction, TaskScheduler scheduler, CancellationToken cancellationToken,
                                   TaskContinuationOptions continuationOptions, ref StackCrawlMark2 stackMark)
        {
            ThrowIfDisposed();
