...
namespace System.Threading.Tasks
{
    ...
    public class Task : IThreadPoolWorkItem, IAsyncResult, IDisposable
    {
        ...
        [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark2 local var have to be marked non-inlineable            
        ...
        internal Task(Action<object> action, object state, Task parent, CancellationToken cancellationToken,
            TaskCreationOptions creationOptions, InternalTaskOptions internalOptions, TaskScheduler scheduler, ref StackCrawlMark2 stackMark)
        ...
        internal static Task InternalStartNew(
            ...
            TaskCreationOptions options, InternalTaskOptions internalOptions, ref StackCrawlMark2 stackMark)
        {
            // Validate arguments.
            if (scheduler == null)
            {
...
#if PFX_LEGACY_3_5
            OperationCanceledException2 exceptionAsOce = unhandledException as OperationCanceledException2;
#else
        ...
        internal bool InternalCancel(bool bCancelNonExecutingOnly)
        {
            ...
            if ((m_stateFlags & TASK_STATE_STARTED) != 0)
            {
                ...
                if (!bPopSucceeded && bCancelNonExecutingOnly && ts != null && ts.RequiresAtomicStartTransition)
                {
        ...
        private Task ContinueWith(Action<Task> continuationAction, TaskScheduler scheduler,
            CancellationToken cancellationToken, TaskContinuationOptions continuationOptions, ref StackCrawlMark2 stackMark)
        {
            ThrowIfDisposed();
        ...
        public static int WaitAny(Task[] tasks, int millisecondsTimeout, CancellationToken cancellationToken)
        {
            ...
            // Due to potential races, we need to check for null/disposed/completed again
