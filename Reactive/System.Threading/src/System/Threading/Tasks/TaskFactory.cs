...
namespace System.Threading.Tasks
{
    ...
    public class TaskFactory
    {
        ...
        // private version that supports StackCrawlMark2.
        ...
        public Task FromAsync<TArg1, TArg2, TArg3>(
            Func_<TArg1, TArg2, TArg3, AsyncCallback, object, IAsyncResult> beginMethod,
            Action<IAsyncResult> endMethod,
        ...
        // a private version that supports StackCrawlMark2
        private static Task ContinueWhenAll(Task[] tasks, Action<Task[]> continuationAction, TaskContinuationOptions continuationOptions,
            CancellationToken cancellationToken, TaskScheduler scheduler, ref StackCrawlMark2 stackMark)
        {
            //check arguments
        ...
        private static Task ContinueWhenAll<TAntecedentResult>(Task<TAntecedentResult>[] tasks, Action<Task<TAntecedentResult>[]> continuationAction, 
            TaskContinuationOptions continuationOptions, CancellationToken cancellationToken, TaskScheduler scheduler, ref StackCrawlMark2 stackMark)
        {
            //check arguments
            CheckMultiTaskContinuationOptions(continuationOptions);
            if (tasks == null) throw new ArgumentNullException("tasks");
