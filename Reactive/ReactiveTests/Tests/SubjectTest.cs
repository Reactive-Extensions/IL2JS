...
{
    [TestClass]
    public partial class SubjectTest : Test
    {
        [TestMethod]
        public void Subscribe_ArgumentChecking()
        {
            Throws<ArgumentNullException>(() => new Subject<int>().Subscribe(null));
        }

        [TestMethod]
        public void OnError_ArgumentChecking()
        {
            Throws<ArgumentNullException>(() => new Subject<int>().OnError(null));
        }
