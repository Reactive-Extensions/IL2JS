...
namespace Microsoft.ServiceBus.Common
{
    ...
    sealed class InputQueue<T> : IDisposable where T : class
    {
        ...
        [SuppressMessage(FxCop.Category.Performance, FxCop.Rule.MarkMembersAsStatic, Justification = "Standard Begin/End Async pattern.", Scope = "Member", Target = "Microsoft.ServiceBus.Common.InputQueue`1.#DisposeItem(Microsoft.ServiceBus.Common.InputQueue`1<!0>+Item)")]
        ...
        [SuppressMessage(FxCop.Category.Performance, FxCop.Rule.MarkMembersAsStatic, Justification = "Standard Begin/End Async pattern.", Scope = "Member", Target = "Microsoft.ServiceBus.Common.InputQueue`1.#EndWaitForItem(System.IAsyncResult)")]
        ...
        class AsyncQueueReader : AsyncResult, IQueueReader
        {
                ...
                : base(callback, state)
            {
                ...
                {
                    base.VirtualCallback = new VirtualCallbackDelegate(inputQueue.AsyncCallbackGenerator());
                }
