...
namespace Microsoft.ServiceBus.Common
{
    ...
    {
        public static void PrepareForRethrow(this Exception exception)
        {
        }
    }
    ...
    static class Fx
    {
        const string defaultEventSource = "Microsoft-ServiceBus";
        ...
        static ExceptionTrace exceptionTrace = new ExceptionTrace();
