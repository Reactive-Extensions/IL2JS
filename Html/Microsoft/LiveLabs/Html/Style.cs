...
namespace Microsoft.LiveLabs.Html
{
    ...
    public sealed class Style
    {
        ...
        extern public string MinWidth { get; set; }
        extern public string MaxWidth { get; set; }
        extern public string Height { get; set; }
        extern public string MaxHeight { get; set; }
        ...
        // Hide string/int polymorphism of underlying JavaScript
        [Import(@"function(inst) { 
                     var zi = inst.zIndex; 
                     if (typeof zi == 'number') 
                         return zi;
                     else if (typeof zi == 'string')
                         return parseInt(zi); 
                     else 
                         return parseInt(zi.toString()); 
                 }")]
        extern private static int GetZIndex(Style inst);

        [Import(@"function(inst, value) { inst.zIndex = value; }")]
        extern private static void SetZIndex(Style inst, int value);
        ...
        extern public int PixelTop { get; set; }
        extern public int PixelLeft { get; set; }
        extern public int PixelWidth { get; set; }
        extern public int PixelHeight { get; set; }
        extern public float PosTop { get; set; }
        extern public float PosLeft { get; set; }
        extern public float PosWidth { get; set; }
        extern public float PosHeight { get; set; }
